...
<?php
        ...
        if($_SESSION['login_user'] != "invalid username or password"){
  ...
  <div class="modal-content">
    ...
    <form class = "form-signin" role = "form" action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
        <div>
          ...
          <br>
          <input type="submit" name="submit" id="myBtn" value="Login">
          <?php 
          if(isset($_SESSION['login_user'])){
...
sbtn.onclick = function(){
    document.getElementById("wrongpass").innerHTML = "Wrong Username of Password";
}
    </script>
  </div>
